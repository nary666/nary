...
module.exports.run = async (blaki, message, args) => {
    ...
    let HOST = message.guild.roles.find("name", "Owner");
    ...
    .setColor("#FFC125")
    .setTitle("**ARENA SOLO CUSTOM **__REMAKE__** !**")
    .setURL('https://discord.js.org/')
    .addField("**HASŁO:**", `**${pass}**`, true)
    .addField("**HOST:**", `${message.author}`, true)
    .addField("**ZASADY:**", zasady0 + `\n` +zasady1 + `\n`+ zasady2 + `\n`+ zasady3)
    .setTimestamp(message.createdAt)
    .setFooter("Gra zacznie się o godzinie 18:05 | Bot stworzony przez gs_nary#1297", "https://i.imgur.com/10WUhHy.png");
